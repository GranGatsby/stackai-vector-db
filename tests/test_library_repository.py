...
class TestInMemoryLibraryRepository:
    ...
    def test_create_library_success(
        self, repository: InMemoryLibraryRepository, sample_library: Library
    ):
    ...
    def test_create_library_duplicate_name_fails(
    ...
    def test_create_library_case_insensitive_names(
        self, repository: InMemoryLibraryRepository
    ):
    ...
    def test_update_library_same_name_succeeds(
        self, repository: InMemoryLibraryRepository
    ):
    ...
    def test_update_library_case_insensitive_conflict(
        self, repository: InMemoryLibraryRepository
    ):
