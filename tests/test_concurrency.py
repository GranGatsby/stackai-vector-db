...
class TestConcurrency:
    ...
    def test_concurrent_writes_with_conflicts(self, repository: InMemoryLibraryRepository):
    ...
    def test_concurrent_read_write_operations(self, repository: InMemoryLibraryRepository):
    ...
    def test_concurrent_updates_same_library(self, repository: InMemoryLibraryRepository):
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            futures = [
                executor.submit(update_operation, f"Updated {i}")
                for i in range(3)
            ]
