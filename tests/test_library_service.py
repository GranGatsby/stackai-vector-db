...
class TestLibraryService:
    ...
    def test_list_libraries_with_pagination(self, service: LibraryService, mock_repository):
    ...
    def test_get_library_success(self, service: LibraryService, mock_repository, sample_library: Library):
    ...
    def test_get_library_by_name_success(self, service: LibraryService, mock_repository, sample_library: Library):
    ...
    def test_get_library_by_name_not_found(self, service: LibraryService, mock_repository):
    ...
    def test_create_library_already_exists(self, service: LibraryService, mock_repository):
        """Test creating library when name already exists."""
        # Setup mock
        mock_repository.create.side_effect = LibraryAlreadyExistsError("Duplicate Library")
    ...
    def test_create_library_invalid_name(self, service: LibraryService, mock_repository):
    ...
    def test_update_library_success(self, service: LibraryService, mock_repository, sample_library: Library):
    ...
    def test_update_library_partial(self, service: LibraryService, mock_repository, sample_library: Library):
    ...
    def test_update_library_name_conflict(self, service: LibraryService, mock_repository, sample_library: Library):
        """Test updating library to conflicting name."""
        # Setup mock
        mock_repository.get_by_id.return_value = sample_library
        mock_repository.update.side_effect = LibraryAlreadyExistsError("Conflicting Name")
    ...
    def test_library_name_exists(self, service: LibraryService, mock_repository, sample_library: Library):
