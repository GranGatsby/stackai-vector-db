...
class TestLibrariesAPI:
    ...
    def test_update_library_success(self, client: TestClient):
        ...
        # Create a library
        create_data = {"name": "Original Library", "description": "Original description"}
    ...
    def test_update_library_partial(self, client: TestClient):
        ...
        assert data["metadata"] == create_data["metadata"]  # Unchanged
    ...
    def test_update_library_not_found(self, client: TestClient):
        ...
        response = client.patch(f"/api/v1/libraries/{non_existent_id}", json=update_data)
    ...
    def test_list_libraries_case_insensitive_sorting(self, client: TestClient):
        ...
        expected_order = ["Alpha Library", "beta Library", "Charlie Library", "zebra Library"]
    ...
    def test_list_libraries_pagination(self, client: TestClient):
        ...
        # Create 5 libraries
        libraries_data = [
            {"name": f"Library {i:02d}"} for i in range(1, 6)
        ]
    ...
    def test_crud_workflow(self, client: TestClient):
        ...
        update_response = client.patch(f"/api/v1/libraries/{library_id}", json=update_data)
