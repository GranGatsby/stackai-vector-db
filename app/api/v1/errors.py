...
async def library_already_exists_handler(request: Request, exc: LibraryAlreadyExistsError) -> JSONResponse:
...
async def index_not_built_handler(request: Request, exc: IndexNotBuiltError) -> JSONResponse:
...
async def index_build_error_handler(request: Request, exc: IndexBuildError) -> JSONResponse:
...
async def embedding_dimension_mismatch_handler(request: Request, exc: EmbeddingDimensionMismatchError) -> JSONResponse:
