...
class LinearScanIndex(BaseVectorIndex):
    ...
    def __init__(self, dimension: int = None, distance_metric: str = "euclidean") -> None:
        ...
        self._distance_func = (
            self.euclidean_distance if distance_metric == "euclidean"
            else self.cosine_distance
        )
        
        logger.debug(f"Initialized LinearScanIndex with distance_metric={distance_metric}")
